...
var ThingsFactory = (function () {
    ...
    ThingsFactory.makeAEuqe = function (num) {
        var p;
        for (var i = 0; i < Euqconfig.length; i++) {
            if (Euqconfig[i].id == num) {
                p = new Propertys(Euqconfig[i].atk, Euqconfig[i].crit, Euqconfig[i].def, Euqconfig[i].maxHP, Euqconfig[i].img, Euqconfig[i].name);
                return p;
            }
        }
    };
...
var Euqconfig = [
    ...
    { id: 1005, name: "被当做炒菜锅的传说级盾", atk: 20, def: 400, maxHP: 400, crit: 0, img: "武器_17_png" },
    ...
    { id: 2003, name: "祖父的圣甲", atk: 200, def: 600, maxHP: 1000, crit: 20, img: "盔甲_011_png" },
    ...
    { id: 4001, name: "别人家的小狐狸", atk: 1000, def: 600, maxHP: 1400, crit: 30, img: "npc0_01_png" },
];
